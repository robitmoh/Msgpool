 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $msgpoolSubscribe
 */
?>
...
<div class="msgpoolSubscribe index large-9 medium-8 columns content">
    <h3><?= __('Msgpool Subscribe') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($msgpoolSubscribe as $msgpoolSubscribe): ?>
            <tr>
